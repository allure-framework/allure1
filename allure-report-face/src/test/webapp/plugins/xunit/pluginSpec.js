...
describe('xUnit controllers', function () {
    ...
    beforeEach(module('allure.xunit'));
    ...
    describe('XUnitCtrl', function() {
        ...
        it('should change state when select is called', function() {
            ...
            expect(state.go).toHaveBeenCalledWith('xunit.testsuite', {testsuiteUid: 'suite3'});
            scope.$apply("testcase.uid = 'case1'");
            expect(state.go).toHaveBeenCalledWith('xunit.testsuite.testcase', {testcaseUid: 'case1'});
        });
