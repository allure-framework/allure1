/*global describe:true, it:true, beforeEach:true, afterEach:true, expect:true, spyOn:true, module:true, inject:true, jasmine:true */
describe('Testcases status switcher', function () {
    'use strict';
    var store;

    beforeEach(module('allure.core.testcase.statusSwitcher'));
